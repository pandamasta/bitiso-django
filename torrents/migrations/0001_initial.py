    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mini_image', models.ImageField(blank=True, default='', null=True, upload_to='img/project/mini/')),
                ('small_image', models.ImageField(blank=True, default='', null=True, upload_to='img/project/small/')),
                ('medium_image', models.ImageField(blank=True, default='', null=True, upload_to='img/project/medium/')),
                ('large_image', models.ImageField(blank=True, default='', null=True, upload_to='img/project/large/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True, verbose_name='Deleted at')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='torrents.category', verbose_name='Category')),
