...
STATIC_URL = '/static/'
STATIC_ROOT = '/srv/bitiso/static'

MEDIA_ROOT= '/srv/bitiso/media'
...
BITISO_TRACKER_STATS_PAGE =  os.environ['BITISO_TRACKER_STATS_PAGE']
BITISO_TRACKER_STATS_FILES =  os.environ['BITISO_TRACKER_STATS_FILES']
